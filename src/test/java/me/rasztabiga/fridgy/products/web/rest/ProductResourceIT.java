...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).eanCode(DEFAULT_EAN_CODE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).eanCode(UPDATED_EAN_CODE);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getEanCode()).isEqualTo(DEFAULT_EAN_CODE);
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).eanCode(UPDATED_EAN_CODE);
        ...
        assertThat(testProduct.getEanCode()).isEqualTo(UPDATED_EAN_CODE);
    }
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).eanCode(UPDATED_EAN_CODE);
